...
<?php if(isset($page_name)){ ?>
    <?php
    echo file_get_contents($_SERVER['DOCUMENT_ROOT'].'/application/views/templates/ua/assets/js/'.$page_name.'.min.js');
    ?>
<?php }else {?>
    <?php
    echo file_get_contents($_SERVER['DOCUMENT_ROOT'].'/application/views/templates/ua/assets/js/home.min.js');
    ?>
<?php } ?>
</script>
<!-- chat face -->
