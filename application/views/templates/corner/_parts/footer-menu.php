        ...
        <div class="top-footer-wrap clearfix">
            ...
            <div class="top-footer-block">
                <aside id="apsi_widget-2" class="widget widget_apsi_widget">
                    <h1 class="widget-title">Social Links</h1>
            ...
            <div class="top-footer-block">
                <aside id="text-2" class="widget widget_text">
                    ...
                    <div class="textwidget">
                        <ul>
                            <li
                                class="page_item <?php if(isset($current_menu['home'])) echo 'current_page_item';?>"><a href="/">Home</a></li>
                            ...
                            <?php }?>
                            <li class="page_item <?php if(isset($current_menu['faqs'])) echo 'current_page_item';?>"><a href="/faqs/">FAQS</a></li>
                            <li class="page_item <?php if(isset($current_menu['aboutus'])) echo 'current_page_item';?>"><a href="/about-me/">About Me</a></li>
                            <li class="page_item <?php if(isset($current_menu['contacts'])) echo 'current_page_item';?>"><a href="/contact-us/">Contact Us</a></li>
                        </ul>
                    </div>
                </aside>
            </div>
